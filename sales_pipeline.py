...
def classify_columns(df):
    ...
    # measure" -- even if every value happens to be numeric (e.g. a
    # "Location Code" or "GST No" column of digits), it must never be
    # summed, averaged, or charted as if it were an amount/quantity.
